...
public class StudentController {
    ...
    @PutMapping("/studentEnrollment/{student_id}/{course_id}")
    public ResponseEntity studentEnrollment(@PathVariable Integer student_id , @PathVariable Integer course_id ){
        studentService.studentEnrollment(student_id,course_id);
    ...
    public ResponseEntity getMostPopularCourses(){
        return ResponseEntity.status(200).body(studentService.getMostPopularCourses());
    }
